...
<template>
  ...
  <div
    class="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:rounded-lg"
  >
    <div class="relative z-20 h-15 md:h-35">
      <img
    ...
    <div class="px-4 pb-2 text-center lg:pb-4 xl:pb-6">
      <div
      ...
      >
        <div class="relative drop-shadow-2">
          <img src="@assets/images/user/user.png" alt="profile" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        <h3 class="mb-1 text-2xl font-medium text-black dark:text-white">{{ user.name }}</h3>
